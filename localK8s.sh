...
SCRIPT_DIR="$EXEC_DIR/scripts/internal"
...
_initDBC(){
  echo "DBC: Setup Namespace "
  kubectl create namespace dbc

  echo "DBC: Mark Node for ofcworkload"
  kubectl label nodes "$KIND_CLUSTER_NAME-control-plane" agentpool=ofcworkload
}
